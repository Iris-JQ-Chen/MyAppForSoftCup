...
//        briefList.add(answerBrief);
    ...
    private void initView(){
        toolbar = (Toolbar)findViewById(R.id.toolbar_on_history);
        ...
        floatingActionButton = (FloatingActionButton)findViewById(R.id.fab_on_history);
        floatingActionButton.setOnClickListener(this);

        layoutManager = new LinearLayoutManager(this);
        adapterBrief = new AdapterBrief(briefList);
        recyclerView = (RecyclerView)findViewById(R.id.recycler_view_on_history);
